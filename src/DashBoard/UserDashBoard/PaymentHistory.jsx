...
const PaymentHistory = () => {
    ...
    const { data, isLoading, isError, refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSecure.get(`/ssl-payment/user/${user.email}?page=${page}`);
            return res.data;
        }
    })
    ...
    if (isError) {
        return <div className='text-5xl text-center font-black text-red-500'>Error loading payment history</div>
    }
