...
const Login = () => {
    ...
    const { setUser, loginUser, googleSignIn, gitHubSignIn } = useAuth();
    ...
    const onSubmit = async (data) => {
        ...
        loginUser(email, password)
            ...
            .catch((err) => {
                toast.error(err.message == "Firebase: Error (auth/invalid-credential)." ? "Invalid Email or Password" : err.message);
            })
    }
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-linear-to-br from-primary via-primary/90 to-accent overflow-hidden py-25">
                ...
                <div className="absolute inset-0">
                    <motion.div
                        ...
                        className="absolute top-10 left-20 w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center"
                    >
                    ...
                    <motion.div
                        ...
                        className="absolute bottom-10 left-25 w-14 h-14 bg-white/20 backdrop-blur-sm rounded-xl flex items-center justify-center"
                    >
                            ...
                            <div className=''>
                                <div className='flex flex-col space-y-4'>
                                    ...
                                    <div>
                                        ...
                                        {
                                            errors.password?.type === 'maxLength' && (<span className='text-red-400'>Password must be at most 20 characters</span>)
                                        }
                                        {
                                            errors.password?.type === 'pattern' && (<span className='text-red-400'>Password must contain at least one uppercase letter</span>)
                                        }
                                    </div>
                                    {/* submit button */}
                                    <div>
